...
public class DataGradeController {
    ...
    @ApiOperation(value = "刷所有表的等级", produces = "application/json;charset=UTF-8")
    @GetMapping(value = "/updateTableGrade")
    public Response updateTableGrade() {
        return Response.success(dataGradeService.updateTableGrade());
    }
}
