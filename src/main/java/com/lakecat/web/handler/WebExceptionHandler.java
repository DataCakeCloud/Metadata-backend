package com.lakecat.web.handler;
...
public class WebExceptionHandler {
    ...
    public BaseResponse<?> beanValidate(MethodArgumentNotValidException e) {
        ...
        return BaseResponse.error(BaseResponseCodeEnum.CLI_PARAM_ILLEGAL.name(), errorMessage.toString());
    }
    ...
    public BaseResponse<?> beanValidate(Exception e) {
        ...
        return BaseResponse.error(BaseResponseCodeEnum.CLI_PARAM_ILLEGAL.name(), e.getMessage());
    }
    ...
    public BaseResponse<?> throwable(Throwable e) {
        ...
        return BaseResponse.error(BaseResponseCodeEnum.SYS_ERR.name(), e.getMessage());
    }
    ...
    public BaseResponse<?> serviceException(Throwable e) {
        ...
        return BaseResponse.error(((ServiceException) e).getCode(), ((ServiceException) e).getCodeStr(), e.getMessage(), ((ServiceException) e).getData());
    }
}
